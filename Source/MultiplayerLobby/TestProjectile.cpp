...
ATestProjectile::ATestProjectile()
{
	...
	{
		SphereComponent->OnComponentHit.AddDynamic(this, &ATestProjectile::OnProjectileImpact);
	}
...
void ATestProjectile::OnProjectileImpact(UPrimitiveComponent* HitComponent, AActor* OtherActor, UPrimitiveComponent* OtherComp, FVector NormalImpulse, const FHitResult& Hit)
{
	if (OtherActor)
	{
